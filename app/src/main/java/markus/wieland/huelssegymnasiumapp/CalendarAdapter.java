...
public class CalendarAdapter extends QueryableAdapter<Long, CalendarEntryWithSubject, CalendarAdapter.CalendarViewHolder> {

    public CalendarAdapter(OnItemInteractListener<CalendarEntryWithSubject> onItemInteractListener) {
    ...
    public class CalendarViewHolder extends DefaultViewHolder<CalendarEntryWithSubject> {
        ...
        public void bindViews() {
            ...
            subjectName = findViewById(R.id.item_calendar_subject);
            title = findViewById(R.id.item_calendar_title);
            description = findViewById(R.id.item_calendar_description);
            color = findViewById(R.id.item_calendar_color);
        }
